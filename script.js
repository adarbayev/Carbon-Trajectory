...
function closeGrowthRateModal() {
    growthRateModal.classList.remove('active');
}
function saveGrowthRateModal() {
...
function openMeasuresModal(scenarioId) {
...
function saveAndCloseMeasuresModal() {
